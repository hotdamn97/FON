...
contract FORCEOFNATURE is BEP20, Auth {
    ...
    string public constant name = "Force of Nature";
    string public constant symbol = "FON";
    ...
    uint256 public totalFee = marketingFee + liquidityFee + devFee + stakingFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x980d758320381509fC98bcF970d850EaBE2f723A;
        devFeeReceiver = 0xc3f4a9B4ACbF44fDe8C829d54a4D0899662388CA;
    ...
    function takeFee(address sender, uint256 amount, address recipient) internal returns (uint256) {
        ...
        if(stakingTokens > 0){
            balanceOf[stakingFeeReceiver] = balanceOf[stakingFeeReceiver].add(stakingTokens);
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _stakingFee, uint256 _devFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        stakingFee = _stakingFee;
        devFee = _devFee;
        totalFee = _liquidityFee + _marketingFee + devFee + _stakingFee;
        
        _updatefees();
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _stakingFeeReceiver) external onlyOwner {
        ...
        require(_stakingFeeReceiver != address(0),"staking fee address cannot be zero address");
